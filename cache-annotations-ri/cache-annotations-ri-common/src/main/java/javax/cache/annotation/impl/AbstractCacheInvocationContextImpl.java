 ...
 */
public abstract class AbstractCacheInvocationContextImpl<I> implements CacheInvocationContext<Annotation> {
     ...
     */
    public AbstractCacheInvocationContextImpl(StaticCacheInvocationContext<? extends Annotation> staticCacheInvocationContext, 
            I invocation) {
